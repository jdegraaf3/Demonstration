 ...
 * 
 * Description: This file tests my implementation of my hash maps along with the methods performed.
 * 				I do this using junit to compare expected outputs with given outputs from each
 * 				method.
 */
